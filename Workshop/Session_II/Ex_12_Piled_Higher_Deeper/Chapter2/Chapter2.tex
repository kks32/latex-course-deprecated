...
\begin{figure}
  \centering
  \subfloat[A Tom and Jerry]{\label{fig:TomJerry}\includegraphics[width=0.5\textwidth]{Chapter2/Figures/TomandJerry.jpg}}                
  \subfloat[A Wall-E]{\label{fig:WallE}\includegraphics[width=0.5\textwidth]{Chapter2/Figures/WallE.jpg}}
  \subfloat[A Minion]{\label{fig:Minnion}\includegraphics[width=0.5\textwidth]{Chapter2/Figures/minion.jpg}}
