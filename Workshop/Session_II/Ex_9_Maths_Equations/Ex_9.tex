...
% try using [fleqn] as a document class option to see what happens
% then add & on left hand side of the equals sign on all equations and see the output like y & = ax+ b
...
% 6. Try using gather environment to center the equations
...
% 7. If you have a long equation you can fold the equation using a newline \\
%\begin{multline}
